...
| [`database-conventions`](../templates/docs/rules/database-conventions.md) (UUID PKs) | new `create_table` in `db/migrate/` lacking `id: :uuid` | low | Scope to new migrations only; never re-scan existing schema. |
